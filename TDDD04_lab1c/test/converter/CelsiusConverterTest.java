...
public class CelsiusConverterTest extends ComponentTestFixture {
	...
	public void testInvalidLookupString() throws Exception {
		assertEquals("!idontexist.label.text!", CelsiusConverter.lookupString("idontexist.label.text"));
	}

	public void testClickEnter() throws Exception {
		tempCelsius.setText("-300");
		//tt.actionEnterText(tempCelsius, "-300"); //$NON-NLS-1$
		tt.actionActionMap(tempCelsius, "notify-field-accept");
		assertEquals("NA", outputLabel.getText());
	}
